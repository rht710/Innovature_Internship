...
# SECURITY
SECRET_KEY = 'django-insecure-i&pl)xdth@ovmq+t#uda11x4g84w-4e7e+*-*-$dgoxs39_^^2'
DEBUG = True
ALLOWED_HOSTS = []
...
MIDDLEWARE = [
    ...
    'notes.middleware.RoleBasedAccessMiddleware',
]
...
EMAIL_PORT = 465
EMAIL_USE_SSL = True
EMAIL_HOST_USER = 'YOUR_EMAIL_ID'  # Replace with actual email
