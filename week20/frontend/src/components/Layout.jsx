...
import { ShoppingBag, Home, Info, Globe, User, Shield, ShoppingCart } from "lucide-react";
        ...
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 h-16 flex items-center justify-between">
          ...
          <div className="flex items-center gap-4">
            ...
            >
              ...
              {cartCount > 0 && (
                <span className="absolute -top-1 -right-1 flex h-5 w-5 items-center justify-center rounded-full bg-indigo-600 text-[10px] font-bold text-white animate-bounce-once">
                  {cartCount}
                </span>
              )}
            </Link>
