                    ...
                    >
                      ...
                      <div className="relative h-56 overflow-hidden bg-slate-100">
                        <img
                          ...
                          e.target.src = "https://via.placeholder.com/400x300?text=Placeholder";
                        }}
                        />
                        <div className="absolute top-4 left-4">
                          <span className="bg-white/95 backdrop-blur-sm text-indigo-700 px-3 py-1 rounded-full text-xs font-bold shadow-sm uppercase tracking-wider">
                            {product.category_name}
                          </span>
                        </div>
                        {product.stock <= 0 ? (
                          <div className="absolute inset-0 bg-slate-900/60 backdrop-blur-xs flex items-center justify-center">
                            <span className="bg-red-600 text-white font-extrabold text-xs px-4 py-2 rounded-lg tracking-widest uppercase">
                              Out Of Stock
                            </span>
                          </div>
                        ) : product.stock <= 5 ? (
                          <div className="absolute top-4 right-4">
                            <span className="bg-amber-500 text-white font-bold text-[10px] px-2.5 py-1 rounded-lg tracking-wider uppercase">
